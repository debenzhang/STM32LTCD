/***
   ...
   *  @description
	*
	*	实验平台：反客STM32F429IGT6核心板(型号：FK429M2) + 反客800*480分辨率的RGB屏幕
	*	淘宝地址：https://shop212360197.taobao.com
	*	QQ交流群：536665479
	*
>>>>> V1.1 版本变更说明(2020-10-14)：
	*
	*	1. 将驱动文件名称由 “touch_050.c” 、“touch_070.c” 改为 “touch_800x480.c”
...
__IO static uint8_t Modify_Flag = 0;	// 触摸坐标修改标志位
...
*	返 回 值: 无
*	函数功能: 识别屏幕面板的版本
*	说    明: 在 7寸屏 V1.1 之前的硬件版本，触摸屏的分辨率为1024*600，为了程序上的兼容，这里进行判断处理，
